...
#Motive: Take a gene list as input and to subset an edge list to only those edges at least one of those genes is found in.
...
with open(args.edges) as edges:
    for line in edges:
        ...
        if (group1 in gene_l or group2 in gene_l):
            out.write(line)
